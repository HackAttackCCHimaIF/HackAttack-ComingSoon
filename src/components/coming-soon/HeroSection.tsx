...
const StarryBackground = lazy(() => import("./planet/StarryBackground"));
...
const HeroSection = () => {
  ...
  const planetAnimationProps = React.useMemo<MotionProps>(
    () => ({
      animate: {
        scale: [1, 1.05, 0.95, 1],
        rotate: [0, 2, -2, 0],
  ...
  const planet2AnimationProps = React.useMemo<MotionProps>(
    () => ({
      animate: {
        scale: [1, 1.05, 0.95, 1],
        rotate: [0, -2, 2, 0],
  ...
  return (
    <div className="relative w-full min-h-screen flex items-center justify-start text-white overflow-hidden">
      ...
      {/* Starfield - only render on client side */}
      {isClient && (
        <Suspense fallback={null}>
          <StarryBackground count={15} />
        </Suspense>
      )}
      ...
      <div className="w-[95%] mx-auto z-10">
        <div className="container px-4 w-fit">
          ...
          >
            ...
            {/* Only render floating orbs on client side */}
            {isClient && (
              <>
                {/* Floating Orbs */}
                <FloatingOrb
                ...
                <div className="absolute w-[120px] h-[120px] top-[15%] right-[5%] sm:w-[140px] sm:h-[140px] sm:top-[20%] sm:right-[70%] md:w-[160px] md:h-[160px] md:top-[16%] md:right-[10%] lg:w-[180px] lg:h-[180px] lg:top-[15%] lg:right-[12%] xl:w-[200px] xl:h-[200px] xl:top-[16%] xl:right-[25%]">
                  <FloatingOrb
                    ...
                    animationProps={planetAnimationProps}
                  />
                </div>
                ...
                <FloatingOrb
                  ...
                  animationProps={planet2AnimationProps}
                />
              </>
            )}
            ...
            >
              ...
              {/* reCAPTCHA - only render on client side */}
              {isClient && (
